...
!function () {
    ...
    legend,input,textarea,p,blockquote,th,td,hr,button,article,aside,details,
...
!function (a, b) {
    ...
    var d, e = a.document, f = e.documentElement, g = e.querySelector('meta[name="viewport"]'), h = e.querySelector('meta[name="flexible"]'),
        i = 0, j = 0, k = b.flexible || (b.flexible = {});
    if (g) {
