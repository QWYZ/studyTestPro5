...
import { Input, DatePicker, InputNumber, Form, Row, Col, Button, Select, TreeSelect } from 'antd';
...
const SearchForm = (props) => {
  ...
  const { formItems, component } = props;
  ...
  return (
    <Form form={form} component={component} className={styles.antAdvancedSearchForm}>
